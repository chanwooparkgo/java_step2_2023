...
public class GenericMain {
	...
	public static<T,V>double makeReckangle(Point<T,V> p1, Point<T,V>p2) {
		...
		double bottom = ((Number)p2.getY()).doubleValue();//밑에 v
	...
	public static void main(String[] args) {
		...
		Point<Integer, Double>p1= new Point<Integer, Double>(0, 0.0);//행 렬
		Point<Integer, Double>p2= new Point<>(10, 10.0);
		
		double rect= GenericMain.makeReckangle(p1,p2);
		System.out.println("두 포인트로 만들어진 사각형의 넓이: "+rect+"입니다");
